                    ...
                    <div>
                        ...
                        <p class="text-gray-600 mb-4">Status:
                            ...
                            @switch($appointment->status)
                                ...
                                @case('declined')
                                    <span class="font-semibold text-red-500">Declined</span>
                                @break

                                @case('cancelled')
                                    <span class="font-semibold text-red-500">Cancelled</span>
                                @break
                        ...
                        @if ($appointment->status != 'declined' && $appointment->status != 'cancelled' && $appointment->status != 'approved')
                            <div class="mt-2 mb-2">
                                <button wire:click="cancelAppointment({{ $appointment->id }})"
                                    class="text-sm bg-red-500  hover:scale-95 flex space-x-1 px-2 text-white py-1 rounded-lg hover:bg-red-700">
